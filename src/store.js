...
import {
    ...
    TENANT_LIST_SUCCESS,
    CLIENT_LIST_SUCCESS, CLIENT_DETAIL_SUCCESS, CLIENT_COMMENT_LIST_REQUEST, DEACTIVATED_CLIENT_LIST_SUCCESS,
    ...
    PARTNER_COMMENT_LIST_SUCCESS, STAFF_COMMENT_LIST_SUCCESS, STAFF_LIST_SUCCESS, STAFF_DETAIL_SUCCESS,
...
const localStorageMiddleware = ({ getState }) => {
    return next => action => {
        ...
        if ([
            ...
            SKILL_SET_LIST_SUCCESS, INSURANCE_REQUIREMENT_LIST_SUCCESS, SERVICE_FEE_LIST_SUCCESS,
            DEACTIVATED_CLIENT_LIST_SUCCESS, HOW_HEAR_LIST_SUCCESS, TAG_LIST_SUCCESS,
