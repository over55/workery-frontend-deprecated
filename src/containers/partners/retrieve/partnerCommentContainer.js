...
import OrderListComponent from "../../../components/partners/retrieve/partnerCommentComponent";
...
const mapStateToProps = function(store) {
    return {
        ...
        partnerCommentList: store.partnerCommentListState,
...
const mapDispatchToProps = dispatch => {
    return {
        ...
        postPartnerComment: (postData, successCallback, failedCallback) => {
            dispatch(postPartnerComment(postData, successCallback, failedCallback))
        },
    }
}
