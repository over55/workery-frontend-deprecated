...
import PartnerAvatarUpdateOperationComponent from "../../../components/partners/operations/partnerAvatarUpdateOperationComponent";
import { setFlashMessage } from "../../../actions/flashMessageActions";
import { postPartnerAvatarCreateOrUpdate } from "../../../actions/partnerActions";
import { clearFlashMessage } from "../../../actions/flashMessageActions";
import { validateImageInput } from "../../../validators/fileValidator"


class PartnerAvatarUpdateOperationContainer extends Component {
    /**
     *  Initializer & Utility
     *------------------------------------------------------------
     */
    ...
    onSuccessPostCallback(response) {
        ...
        this.setState(
            ...
            ()=>{
                ...
                this.props.setFlashMessage("success", "Partner avatar has been successfully updated.");
    ...
    handleFile(e) { // DJANGO-REACT UPLOAD: STEP 3 OF 4.
        ...
        this.setState({
            ...
            this.props.postPartnerAvatarCreateOrUpdate(
                this.getPostData(),
    ...
    render() {
        ...
        const partnerFiles = this.props.partnerFileList ? this.props.partnerFileList.results : [];
        return (
            <PartnerAvatarUpdateOperationComponent
                id={id}
                partner={partner}
...
const mapDispatchToProps = dispatch => {
    return {
        ...
        postPartnerAvatarCreateOrUpdate: (postData, successCallback, failedCallback) => {
            dispatch(postPartnerAvatarCreateOrUpdate(postData, successCallback, failedCallback))
        },
    }
}
...
export default connect(
    mapStateToProps,
    mapDispatchToProps
)(PartnerAvatarUpdateOperationContainer);
