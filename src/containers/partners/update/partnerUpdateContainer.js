...
import PartnerUpdateComponent from "../../../components/partners/update/partnerUpdateComponent";
...
class PartnerUpdateContainer extends Component {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            isOkToText: this.props.partnerDetail.isOkToText,
            isOkToEmail: this.props.partnerDetail.isOkToEmail,
        }
