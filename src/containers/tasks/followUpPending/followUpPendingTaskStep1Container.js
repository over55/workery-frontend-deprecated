...
import FollowUpPendingTaskStep1Component from "../../../components/tasks/followUpPending/followUpPendingTaskStep1Component";
import { pullTaskDetail } from "../../../actions/taskActions";
import { setFlashMessage } from "../../../actions/flashMessageActions";


class FollowUpPendingTaskStep1Container extends Component {
    /**
     *  Initializer & Utility
     *------------------------------------------------------------
     */
    ...
    onClick(e) {
        ...
        e.preventDefault();
        this.props.history.push("/task/4/"+this.state.id+"/step-2");
    }
...
export default connect(
    mapStateToProps,
    mapDispatchToProps
)(FollowUpPendingTaskStep1Container);
