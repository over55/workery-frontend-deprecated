...
import OrderCompletionTaskStep1Component from "../../../components/tasks/orderCompletion/orderCompletionTaskStep1Component";
import { pullTaskDetail } from "../../../actions/taskActions";
import { setFlashMessage } from "../../../actions/flashMessageActions";


class OrderCompletionTaskStep1Container extends Component {
    /**
     *  Initializer & Utility
     *------------------------------------------------------------
     */
    ...
    onClick(e) {
        ...
        e.preventDefault();
        this.props.history.push("/task/6/"+this.state.id+"/step-2");
    }
    ...
    render() {
        return (
            <OrderCompletionTaskStep1Component
                id={this.state.id}
...
export default connect(
    mapStateToProps,
    mapDispatchToProps
)(OrderCompletionTaskStep1Container);
