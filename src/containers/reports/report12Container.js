...
import Report12Component from "../../components/reports/report12Component";
import { WORKERY_REPORT_TWELVE_CSV_DOWNLOAD_API_ENDPOINT } from "../../constants/api";
import { getSubdomain } from "../../helpers/urlUtility";
import { getAccessTokenFromLocalStorage } from "../../helpers/jwtUtility";


class Report12Container extends Component {
    /**
     *  Initializer & Utility
     *------------------------------------------------------------
     */
    ...
    onClick(e) {
        ...
        const url = process.env.REACT_APP_API_PROTOCOL + "://" + schema + "." + process.env.REACT_APP_API_DOMAIN + "/" + WORKERY_REPORT_TWELVE_CSV_DOWNLOAD_API_ENDPOINT+"?token="+accessToken;
        console.log(url);
