...
import { WORKERY_REPORT_TWELVE_CSV_DOWNLOAD_API_URL } from "../../constants/api";
...
class Report12Container extends Component {
    ...
    onClick(e) {
        ...
        const url = process.env.REACT_APP_API_PROTOCOL + "://" + schema + "." + process.env.REACT_APP_API_DOMAIN + "/" + WORKERY_REPORT_TWELVE_CSV_DOWNLOAD_API_URL+"?token="+accessToken;
        console.log(url);
