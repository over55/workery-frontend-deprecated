...
class Report7Container extends Component {
    ...
    onClick(e) {
        ...
        if (isValid) {
            ...
            const url = process.env.REACT_APP_API_PROTOCOL + "://" + schema + "." + process.env.REACT_APP_API_DOMAIN + "/" + WORKERY_REPORT_SEVEN_CSV_DOWNLOAD_API_URL + "?filter_type="+associateType + "&token="+accessToken;
            console.log(url);
