...
import { WORKERY_REPORT_ELEVEN_CSV_DOWNLOAD_API_URL } from "../../constants/api";
import { getSubdomain } from "../../helpers/urlUtility";
import { getAccessTokenFromLocalStorage } from "../../helpers/jwtUtility";


class Report11Container extends Component {
    /**
     *  Initializer & Utility
     *------------------------------------------------------------
     */
    ...
    onClick(e) {
        ...
        const { errors, isValid } = validateReport11Input(this.state);
        ...
        if (isValid) {
            ...
            const url = process.env.REACT_APP_API_PROTOCOL + "://" + schema + "." + process.env.REACT_APP_API_DOMAIN + "/" + WORKERY_REPORT_ELEVEN_CSV_DOWNLOAD_API_URL + "?from_dt="+fromDateString+"&to_dt="+toDateString+"&token="+accessToken;
            console.log(url);
