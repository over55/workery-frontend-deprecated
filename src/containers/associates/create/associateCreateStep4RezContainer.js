...
import AssociateCreateStep4RezComponent from "../../../components/associates/create/associateCreateStep4RezComponent";
import { validateStep4RezCreateInput } from "../../../validators/associateValidator";
import {
...
class AssociateCreateStep4RezContainer extends Component {
    /**
     *  Initializer & Utility
     *------------------------------------------------------------
     */
    ...
    componentDidMount() {
        ...
        localStorage.setItem("workery-create-associate-rez-primaryPhoneTypeOf", TELEPHONE_CONTACT_POINT_TYPE_OF_ID);
        localStorage.setItem("workery-create-associate-rez-secondaryPhoneTypeOf", TELEPHONE_CONTACT_POINT_TYPE_OF_ID);
    }
    ...
    onTextChange(e) {
        ...
        const key = "workery-create-associate-rez-"+[e.target.name];
        localStorage.setItem(key, e.target.value);
    }

    onRadioChange(e) {
        // Get the values.
        const storageValueKey = "workery-create-associate-rez-"+[e.target.name];
        const storageLabelKey =  "workery-create-associate-rez-"+[e.target.name].toString()+"-label";
...
export default connect(
    mapStateToProps,
    mapDispatchToProps
)(AssociateCreateStep4RezContainer);
