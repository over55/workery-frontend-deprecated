...
import AssociateCreateStep4BizComponent from "../../../components/associates/create/associateCreateStep4BizComponent";
import { validateStep4BizCreateInput } from "../../../validators/associateValidator";
import {
...
class AssociateCreateStep4BizContainer extends Component {
    /**
     *  Initializer & Utility
     *------------------------------------------------------------
     */
    ...
    onSelectChange(option) {
        ...
        this.setState(
            ...
            ()=>{
                localStorage.setItem('workery-create-associate-biz-'+[option.selectName].toString(), option.value);
                localStorage.setItem('workery-create-associate-biz-'+[option.selectName].toString()+"Label", option.label);
                localStorageSetObjectOrArrayItem('workery-create-associate-biz-'+optionKey, option);
...
export default connect(
    mapStateToProps,
    mapDispatchToProps
)(AssociateCreateStep4BizContainer);
