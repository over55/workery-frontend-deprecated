...
import AdminAssociateArchiveOperationComponent from "../../../../components/associates/admin/operations/adminAssociateArchiveOperationComponent";
...
class AdminAssociateArchiveOperationContainer extends Component {
    /**
     *  Initializer & Utility
     *------------------------------------------------------------
     */
    ...
    render() {
        ...
        return (
            <AdminAssociateArchiveOperationComponent
                id={id}
                errors={errors}
                isLoading={isLoading}
                reason={reason}
...
export default connect(
    mapStateToProps,
    mapDispatchToProps
)(AdminAssociateArchiveOperationContainer);
