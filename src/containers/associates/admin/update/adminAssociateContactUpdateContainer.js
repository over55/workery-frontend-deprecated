...
class AdminAssociateContactUpdateContainer extends Component {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            telephone: this.props.associateDetail.telephone,
            telephoneTypeOf: this.props.associateDetail.telephoneTypeOf,
            otherTelephone: this.props.associateDetail.otherTelephone,
            otherTelephoneTypeOf: this.props.associateDetail.otherTelephoneTypeOf,
