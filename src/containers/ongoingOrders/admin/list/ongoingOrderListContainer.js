...
import AdminOngoingOrderListComponent from "../../../../components/ongoingOrders/admin/list/adminOngoingOrderListComponent";
import { clearFlashMessage } from "../../../../actions/flashMessageActions";
import { pullOngoingOrderList } from "../../../../actions/ongoingOrderActions";
import { STANDARD_RESULTS_SIZE_PER_PAGE_PAGINATION } from "../../../../constants/api";

class AdminOngoingOrderListContainer extends Component {
    /**
     *  Initializer & Utility
     *------------------------------------------------------------
     */
        ...
        if (type === "sort") {
            ...
            this.setState(
                ...
                ()=>{
                    // STEP 3:
                    // SUBMIT TO OUR API.
                    this.props.pullOngoingOrderList(this.state.offset, this.state.limit, parametersMap, this.onSuccessfulSubmissionCallback, this.onFailedSubmissionCallback);
                }
            );
            ...
            this.setState(
                ...
                ()=>{
                    this.props.pullOngoingOrderList(offset, limit, this.state.parametersMap, this.onSuccessfulSubmissionCallback, this.onFailedSubmissionCallback);
                }
            );
    ...
    onNextClick(e) {
        ...
        this.props.pullOngoingOrderList(offset, this.state.limit, parametersMap, this.onSuccessfulSubmissionCallback, this.onFailedSubmissionCallback);
    }
    ...
    render() {
        return (
            <AdminOngoingOrderListComponent
                {...this}
                {...this.state}
                {...this.props}
            />
...
const mapDispatchToProps = dispatch => {
    return {
        ...
        pullOngoingOrderList: (offset, limit, map, onSuccessCallback, onFailureCallback) => {
            dispatch(
                pullOngoingOrderList(offset, limit, map, onSuccessCallback, onFailureCallback)
            )
        },
...
export default connect(
    mapStateToProps,
    mapDispatchToProps
)(AdminOngoingOrderListContainer);
