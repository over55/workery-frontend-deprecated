...
import OngoingOrderListComponent from "../../../components/ongoingOrders/retrieve/ongoingOrderCommentComponent";
import { clearFlashMessage } from "../../../actions/flashMessageActions";
import { pullOngoingOrderCommentList, postOngoingOrderComment } from "../../../actions/ongoingOrderCommentActions";
import { validateInput } from "../../../validators/commentValidator"


class OngoingOrderCommentContainer extends Component {
    /**
     *  Initializer & Utility
     *------------------------------------------------------------
     */
    ...
    componentDidMount() {
        ...
        // Get our data.
        this.props.pullOngoingOrderCommentList(
            this.state.page,
    ...
    onClick(e) {
        ...
        if (isValid) {
            this.setState({
                ...
                this.props.postOngoingOrderComment(
                    this.getPostData(),
    ...
    render() {
        ...
        const orderComments = this.props.ongoingOrderCommentList ? this.props.ongoingOrderCommentList.results : [];
        return (
...
const mapStateToProps = function(store) {
    return {
        ...
        ongoingOrderCommentList: store.ongoingOrderCommentListState,
...
const mapDispatchToProps = dispatch => {
    return {
        ...
        pullOngoingOrderCommentList: (page, sizePerPage, map, onSuccessListCallback, onFailureListCallback) => {
            dispatch(
                pullOngoingOrderCommentList(page, sizePerPage, map, onSuccessListCallback, onFailureListCallback)
            )
        },
        postOngoingOrderComment: (postData, successCallback, failedCallback) => {
            dispatch(postOngoingOrderComment(postData, successCallback, failedCallback))
        },
    }
}
