...
import OrderReopenOperationComponent from "../../../components/orders/operations/orderReopenOperationComponent";
...
class OrderReopenOperationContainer extends Component {
    ...
    onSuccessfulSubmissionCallback(order) {
        ...
        this.props.setFlashMessage("success", "Order has been successfully re-opened.");
    ...
    onClick(e) {
        ...
        const { errors, isValid } = validateReopenInput(this.state);

        // CASE 1 OF 2: Validation passed successfully.
        if (isValid) {
            this.props.postOrderReopen(
                this.getPostData(),
