...
import AssociateOrderLiteRetrieveComponent from "../../../../components/orders/associate/retrieve/associateOrderLiteRetrieveComponent";
...
class OrderLiteRetrieveContainer extends Component {
    ...
    render() {
        ...
        return (
            <AssociateOrderLiteRetrieveComponent
                id={this.state.id}
                order={order}
