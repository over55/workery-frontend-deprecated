...
import OrderListComponent from "../../../../components/orders/retrieve/file_upload/orderFileUploadAddComponent";
    ...
    onSuccessPostCallback(response) {
        ...
        this.setState(
            ...
            ()=>{
                ...
                this.props.setFlashMessage("success", "Order file has been successfully created.");
