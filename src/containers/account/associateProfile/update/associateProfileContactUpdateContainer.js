...
import AssociateProfileContactUpdateComponent from "../../../../components/account/associateProfile/update/associateProfileContactUpdateComponent";
...
class AssociateProfileContactUpdateContainer extends Component {
    /**
     *  Initializer & Utility
     *------------------------------------------------------------
     */
...
export default connect(
    mapStateToProps,
    mapDispatchToProps
)(AssociateProfileContactUpdateContainer);
