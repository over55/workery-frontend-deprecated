...
import ClientAvatarUpdateOperationComponent from "../../../components/clients/operations/clientAvatarUpdateOperationComponent";
import { setFlashMessage } from "../../../actions/flashMessageActions";
import { postClientAvatarCreateOrUpdate } from "../../../actions/clientActions";
import { clearFlashMessage } from "../../../actions/flashMessageActions";
import { validateImageInput } from "../../../validators/fileValidator"


class ClientAvatarUpdateOperationContainer extends Component {
    /**
     *  Initializer & Utility
     *------------------------------------------------------------
     */
    ...
    onSuccessPostCallback(response) {
        ...
        this.setState(
            ...
            ()=>{
                ...
                this.props.setFlashMessage("success", "Client avatar has been successfully updated.");
                this.props.history.push("/client/"+this.state.id);
            }
        )
    }
    ...
    handleFile(e) { // DJANGO-REACT UPLOAD: STEP 3 OF 4.
        ...
        this.setState({
            ...
            this.props.postClientAvatarCreateOrUpdate(
                this.getPostData(),
    ...
    render() {
        ...
        return (
            <ClientAvatarUpdateOperationComponent
                id={id}
                client={client}
...
const mapDispatchToProps = dispatch => {
    return {
        ...
        postClientAvatarCreateOrUpdate: (postData, successCallback, failedCallback) => {
            dispatch(postClientAvatarCreateOrUpdate(postData, successCallback, failedCallback))
        },
    }
}
...
export default connect(
    mapStateToProps,
    mapDispatchToProps
)(ClientAvatarUpdateOperationContainer);
