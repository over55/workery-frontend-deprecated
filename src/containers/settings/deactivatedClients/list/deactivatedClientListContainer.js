        ...
        if (type === "sort") {
            ...
            this.setState(
                ...
                ()=>{
                    // STEP 3:
                    // SUBMIT TO OUR API.
                    this.props.pullDeactivatedClientList(this.state.page, this.state.sizePerPage, parametersMap, this.onSuccessfulSubmissionCallback, this.onFailedSubmissionCallback);
                }
            );
            ...
            this.setState(
                ...
                ()=>{
                    this.props.pullDeactivatedClientList(page, sizePerPage, this.state.parametersMap, this.onSuccessfulSubmissionCallback, this.onFailedSubmissionCallback);
                }
            );
    ...
    render() {
        ...
        return (
            <DeactivatedClientListComponent
                ...
                totalSize={totalSize}
                deactivatedClientList={this.props.deactivatedClientList}
...
const mapDispatchToProps = dispatch => {
    return {
        ...
        pullDeactivatedClientList: (page, sizePerPage, map, onSuccessCallback, onFailureCallback) => {
            dispatch(
                pullDeactivatedClientList(page, sizePerPage, map, onSuccessCallback, onFailureCallback)
            )
        },
