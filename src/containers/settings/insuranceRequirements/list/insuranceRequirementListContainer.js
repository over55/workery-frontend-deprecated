...
import InsuranceRequirementListComponent from "../../../../components/settings/insuranceRequirements/list/insuranceRequirementListComponent";
import { clearFlashMessage } from "../../../../actions/flashMessageActions";
import { pullInsuranceRequirementList } from "../../../../actions/insuranceRequirementActions";
import { STANDARD_RESULTS_SIZE_PER_PAGE_PAGINATION } from "../../../../constants/api";


class InsuranceRequirementListContainer extends Component {
    /**
     *  Initializer & Utility
     *------------------------------------------------------------
     */
        ...
        if (type === "sort") {
            ...
            this.setState(
                ...
                ()=>{
                    // STEP 3:
                    // SUBMIT TO OUR API.
                    this.props.pullInsuranceRequirementList(this.state.offset, this.state.limit, parametersMap, this.onSuccessfulSubmissionCallback, this.onFailedSubmissionCallback);
                }
            );
            ...
            this.setState(
                ...
                ()=>{
                    this.props.pullInsuranceRequirementList(offset, limit, this.state.parametersMap, this.onSuccessfulSubmissionCallback, this.onFailedSubmissionCallback);
                }
            );
    ...
    onNextClick(e) {
        ...
        this.props.pullInsuranceRequirementList(offset, this.state.limit, parametersMap, this.onSuccessfulSubmissionCallback, this.onFailedSubmissionCallback);
    }
    ...
    render() {
        return (
            <InsuranceRequirementListComponent
                {...this}
                {...this.state}
                {...this.props}
            />
...
export default connect(
    mapStateToProps,
    mapDispatchToProps
)(InsuranceRequirementListContainer);
