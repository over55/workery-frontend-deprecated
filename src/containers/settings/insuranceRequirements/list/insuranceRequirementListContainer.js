...
class InsuranceRequirementListContainer extends Component {
    ...
    componentDidMount() {
        ...
        this.props.pullInsuranceRequirementList(
            this.state.page,
        ...
        if (type === "sort") {
            ...
            this.setState(
                ...
                ()=>{
                    // STEP 3:
                    // SUBMIT TO OUR API.
                    this.props.pullInsuranceRequirementList(this.state.page, this.state.sizePerPage, parametersMap, this.onSuccessfulSubmissionCallback, this.onFailedSubmissionCallback);
                }
            );
            ...
            this.setState(
                ...
                ()=>{
                    this.props.pullInsuranceRequirementList(page, sizePerPage, this.state.parametersMap, this.onSuccessfulSubmissionCallback, this.onFailedSubmissionCallback);
                }
            );
    ...
    render() {
        ...
        return (
            <InsuranceRequirementListComponent
                ...
                totalSize={totalSize}
                insuranceRequirementList={this.props.insuranceRequirementList}
