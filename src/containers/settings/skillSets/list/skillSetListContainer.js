...
import SkillSetListComponent from "../../../../components/settings/skillSets/list/skillSetListComponent";
import { clearFlashMessage } from "../../../../actions/flashMessageActions";
import { pullSkillSetList } from "../../../../actions/skillSetActions";
import { STANDARD_RESULTS_SIZE_PER_PAGE_PAGINATION } from "../../../../constants/api";


class SkillSetListContainer extends Component {
    /**
     *  Initializer & Utility
     *------------------------------------------------------------
     */
    ...
    constructor(props) {
        ...
        parametersMap.set("sort_order", "ASC"); // Don't forget these same values must be set in the `defaultSorted` var inside `SkillSetListComponent`.
        parametersMap.set("sort_field", "category");
        ...
        if (type === "sort") {
            ...
            this.setState(
                ...
                ()=>{
                    // STEP 3:
                    // SUBMIT TO OUR API.
                    this.props.pullSkillSetList(this.state.offset, this.state.limit, parametersMap, this.onSuccessfulSubmissionCallback, this.onFailedSubmissionCallback);
                }
            );
            ...
            this.setState(
                ...
                ()=>{
                    this.props.pullSkillSetList(offset, limit, this.state.parametersMap, this.onSuccessfulSubmissionCallback, this.onFailedSubmissionCallback);
                }
            );
    ...
    onNextClick(e) {
        ...
        this.props.pullSkillSetList(offset, this.state.limit, parametersMap, this.onSuccessfulSubmissionCallback, this.onFailedSubmissionCallback);
    }
...
const mapDispatchToProps = dispatch => {
    return {
        ...
        pullSkillSetList: (offset, limit, map, onSuccessCallback, onFailureCallback) => {
            dispatch(
                pullSkillSetList(offset, limit, map, onSuccessCallback, onFailureCallback)
            )
        },
