...
import HowHearListComponent from "../../../../components/settings/howHears/list/howHearListComponent";
...
class HowHearListContainer extends Component {
    ...
    constructor(props) {
        ...
        parametersMap.set("sort_field", "sort_number");
        ...
        if (type === "sort") {
            ...
            this.setState(
                ...
                ()=>{
                    // STEP 3:
                    // SUBMIT TO OUR API.
                    this.props.pullHowHearList(this.state.offset, this.state.limit, parametersMap, this.onSuccessfulSubmissionCallback, this.onFailedSubmissionCallback);
                }
            );
            ...
            this.setState(
                ...
                ()=>{
                    this.props.pullHowHearList(offset, limit, this.state.parametersMap, this.onSuccessfulSubmissionCallback, this.onFailedSubmissionCallback);
                }
            );
    ...
    onNextClick(e) {
        ...
        this.props.pullHowHearList(offset, this.state.limit, parametersMap, this.onSuccessfulSubmissionCallback, this.onFailedSubmissionCallback);
    }
...
const mapDispatchToProps = dispatch => {
    return {
        ...
        pullHowHearList: (offset, limit, map, onSuccessCallback, onFailureCallback) => {
            dispatch(
                pullHowHearList(offset, limit, map, onSuccessCallback, onFailureCallback)
            )
        },
