...
import VehicleTypeListComponent from "../../../../components/settings/vehicleTypes/list/vehicleTypeListComponent";
import { clearFlashMessage } from "../../../../actions/flashMessageActions";
import { pullVehicleTypeList } from "../../../../actions/vehicleTypeActions";
import { STANDARD_RESULTS_SIZE_PER_PAGE_PAGINATION } from "../../../../constants/api";


class VehicleTypeListContainer extends Component {
    /**
     *  Initializer & Utility
     *------------------------------------------------------------
     */
    ...
    constructor(props) {
        ...
        parametersMap.set("sort_order", "DESC"); // Don't forget these same values must be set in the `defaultSorted` var inside `BulletinBoardItemListComponent`.
        ...
        if (type === "sort") {
            ...
            this.setState(
                ...
                ()=>{
                    // STEP 3:
                    // SUBMIT TO OUR API.
                    this.props.pullVehicleTypeList(this.state.offset, this.state.limit, parametersMap, this.onSuccessfulSubmissionCallback, this.onFailedSubmissionCallback);
                }
            );
            ...
            this.setState(
                ...
                ()=>{
                    this.props.pullVehicleTypeList(offset, limit, this.state.parametersMap, this.onSuccessfulSubmissionCallback, this.onFailedSubmissionCallback);
                }
            );
    ...
    onNextClick(e) {
        ...
        this.props.pullVehicleTypeList(offset, this.state.limit, parametersMap, this.onSuccessfulSubmissionCallback, this.onFailedSubmissionCallback);
    }
...
const mapDispatchToProps = dispatch => {
    return {
        ...
        pullVehicleTypeList: (offset, limit, map, onSuccessCallback, onFailureCallback) => {
            dispatch(
                pullVehicleTypeList(offset, limit, map, onSuccessCallback, onFailureCallback)
            )
        },
