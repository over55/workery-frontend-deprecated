...
import StaffAvatarUpdateOperationComponent from "../../../components/staff/operations/staffAvatarUpdateOperationComponent";
import { setFlashMessage } from "../../../actions/flashMessageActions";
import { postStaffAvatarCreateOrUpdate } from "../../../actions/staffActions";
import { clearFlashMessage } from "../../../actions/flashMessageActions";
import { validateImageInput } from "../../../validators/fileValidator"


class StaffAvatarUpdateOperationContainer extends Component {
    /**
     *  Initializer & Utility
     *------------------------------------------------------------
     */
    ...
    handleFile(e) { // DJANGO-REACT UPLOAD: STEP 3 OF 4.
        ...
        this.setState({
            ...
            this.props.postStaffAvatarCreateOrUpdate(
                this.getPostData(),
...
const mapDispatchToProps = dispatch => {
    return {
        ...
        postStaffAvatarCreateOrUpdate: (postData, successCallback, failedCallback) => {
            dispatch(postStaffAvatarCreateOrUpdate(postData, successCallback, failedCallback))
        },
    }
}
...
export default connect(
    mapStateToProps,
    mapDispatchToProps
)(StaffAvatarUpdateOperationContainer);
