...
import AdminDepositCreateStep2Component from "../../../../components/financials/admin/create/adminDepositCreateStep2Component";
...
class AdminDepositCreateStep2Container extends Component {
    /**
     *  Initializer & Utility
     *------------------------------------------------------------
     */
    ...
    render() {
        ...
        return (
            <AdminDepositCreateStep2Component
                orderId={orderId}
...
export default connect(
    mapStateToProps,
    mapDispatchToProps
)(AdminDepositCreateStep2Container);
