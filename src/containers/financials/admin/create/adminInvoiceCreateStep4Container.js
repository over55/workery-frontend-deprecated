...
import AdminInvoiceCreateStep4Component from "../../../../components/financials/admin/create/adminInvoiceCreateStep4Component";
...
class AdminInvoiceCreateStep4Container extends Component {
    /**
     *  Initializer & Utility
     *------------------------------------------------------------
     */
...
export default connect(
    mapStateToProps,
    mapDispatchToProps
)(AdminInvoiceCreateStep4Container);
