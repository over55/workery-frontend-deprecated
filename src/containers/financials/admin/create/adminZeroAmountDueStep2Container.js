...
import AdminZeroAmountDueStep2Component from "../../../../components/financials/admin/create/adminZeroAmountDueStep2Component";
...
class AdminZeroAmountDueStep2Container extends Component {
    /**
     *  Initializer & Utility
     *------------------------------------------------------------
     */
    ...
    render() {
        ...
        return (
            <AdminZeroAmountDueStep2Component
                orderId={orderId}
...
export default connect(
    mapStateToProps,
    mapDispatchToProps
)(AdminZeroAmountDueStep2Container);
