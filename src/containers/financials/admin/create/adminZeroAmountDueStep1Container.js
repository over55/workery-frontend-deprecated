...
import AdminZeroAmountDueStep1Component from "../../../../components/financials/admin/create/adminZeroAmountDueStep1Component";
...
class AdminZeroAmountDueStep1Container extends Component {
    /**
     *  Initializer & Utility
     *------------------------------------------------------------
     */
    ...
    render() {
        ...
        return (
            <AdminZeroAmountDueStep1Component
                orderId={orderId}
...
export default connect(
    mapStateToProps,
    mapDispatchToProps
)(AdminZeroAmountDueStep1Container);
