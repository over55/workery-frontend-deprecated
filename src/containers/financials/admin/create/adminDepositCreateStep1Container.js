...
import AdminDepositCreateComponent from "../../../../components/financials/admin/create/adminDepositCreateStep1Component";
...
class AdminDepositCreateStep1Container extends Component {
    /**
     *  Initializer & Utility
     *------------------------------------------------------------
     */
...
export default connect(
    mapStateToProps,
    mapDispatchToProps
)(AdminDepositCreateStep1Container);
