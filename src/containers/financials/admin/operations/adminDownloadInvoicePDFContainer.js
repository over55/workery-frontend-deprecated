...
import AdminDownloadInvoicePDFOperationComponent from "../../../../components/financials/admin/operations/adminDownloadInvoicePDFOperationComponent";
...
class AdminDownloadInvoicePDFOperationContainer extends Component {
    /**
     *  Initializer & Utility
     *------------------------------------------------------------
     */
    ...
    render() {
        ...
        return (
            <AdminDownloadInvoicePDFOperationComponent
                orderId={orderId}
                errors={errors}
                isLoading={isLoading}
            />
...
export default connect(
    mapStateToProps,
    mapDispatchToProps
)(AdminDownloadInvoicePDFOperationContainer);
