...
import AdminInvoiceFirstSectionUpdateComponent from "../../../../components/financials/admin/update/adminInvoiceFirstSectionUpdateComponent";
...
class AdminInvoiceFirstSectionUpdateContainer extends Component {
    /**
     *  Initializer & Utility
     *------------------------------------------------------------
     */
    ...
    render() {
        ...
        return (
            <AdminInvoiceFirstSectionUpdateComponent
                orderId={orderId}
...
export default connect(
    mapStateToProps,
    mapDispatchToProps
)(AdminInvoiceFirstSectionUpdateContainer);
