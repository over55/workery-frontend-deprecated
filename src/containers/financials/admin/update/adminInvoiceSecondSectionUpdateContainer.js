...
import AdminInvoiceSecondSectionUpdateComponent from "../../../../components/financials/admin/update/adminInvoiceSecondSectionUpdateComponent";
...
class AdminInvoiceSecondSectionUpdateContainer extends Component {
    /**
     *  Initializer & Utility
     *------------------------------------------------------------
     */
    ...
    render() {
        ...
        return (
            <AdminInvoiceSecondSectionUpdateComponent
                orderId={orderId}
...
export default connect(
    mapStateToProps,
    mapDispatchToProps
)(AdminInvoiceSecondSectionUpdateContainer);
