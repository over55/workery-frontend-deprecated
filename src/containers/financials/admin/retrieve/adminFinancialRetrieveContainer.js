...
import AdminFinancialRetrieveComponent from "../../../../components/financials/admin/retrieve/adminFinancialRetrieveComponent";
...
class AdminFinancialRetrieveContainer extends Component {
    /**
     *  Initializer & Utility
     *------------------------------------------------------------
     */
    ...
    render() {
        ...
        return (
            <AdminFinancialRetrieveComponent
                id={this.state.id}
...
export default connect(
    mapStateToProps,
    mapDispatchToProps
)(AdminFinancialRetrieveContainer);
