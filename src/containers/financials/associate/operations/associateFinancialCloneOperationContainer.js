...
import AssociateFinancialCloneOperationComponent from "../../../../components/financials/associate/operations/associateFinancialCloneOperationComponent";
import { setFlashMessage } from "../../../../actions/flashMessageActions";
import { cloneOrder } from "../../../../actions/orderActions";


class AssociateFinancialCloneOperationContainer extends Component {
    /**
     *  Initializer & Utility
     *------------------------------------------------------------
     */
    ...
    render() {
        ...
        return (
            <AssociateFinancialCloneOperationComponent
                orderId={orderId}
                errors={errors}
                isLoading={isLoading}
                reason={reason}
...
export default connect(
    mapStateToProps,
    mapDispatchToProps
)(AssociateFinancialCloneOperationContainer);
