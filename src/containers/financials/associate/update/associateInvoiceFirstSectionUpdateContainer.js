...
import AssociateInvoiceFirstSectionUpdateComponent from "../../../../components/financials/associate/update/associateInvoiceFirstSectionUpdateComponent";
...
class AssociateInvoiceFirstSectionUpdateContainer extends Component {
    /**
     *  Initializer & Utility
     *------------------------------------------------------------
     */
    ...
    render() {
        ...
        return (
            <AssociateInvoiceFirstSectionUpdateComponent
                orderId={orderId}
...
export default connect(
    mapStateToProps,
    mapDispatchToProps
)(AssociateInvoiceFirstSectionUpdateContainer);
