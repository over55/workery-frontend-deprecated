...
import AssociateInvoiceSecondSectionUpdateComponent from "../../../../components/financials/associate/update/associateInvoiceSecondSectionUpdateComponent";
...
class AssociateInvoiceSecondSectionUpdateContainer extends Component {
    /**
     *  Initializer & Utility
     *------------------------------------------------------------
     */
    ...
    render() {
        ...
        return (
            <AssociateInvoiceSecondSectionUpdateComponent
                orderId={orderId}
...
export default connect(
    mapStateToProps,
    mapDispatchToProps
)(AssociateInvoiceSecondSectionUpdateContainer);
