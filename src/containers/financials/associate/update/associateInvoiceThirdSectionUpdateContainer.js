...
import AssociateInvoiceThirdSectionUpdateComponent from "../../../../components/financials/associate/update/associateInvoiceThirdSectionUpdateComponent";
...
class AssociateInvoiceThirdSectionUpdateContainer extends Component {
    /**
     *  Initializer & Utility
     *------------------------------------------------------------
     */
    ...
    render() {
        ...
        return (
            <AssociateInvoiceThirdSectionUpdateComponent
                orderId={orderId}
...
export default connect(
    mapStateToProps,
    mapDispatchToProps
)(AssociateInvoiceThirdSectionUpdateContainer);
