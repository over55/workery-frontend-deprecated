...
import AssociateFinancialRetrieveComponent from "../../../../components/financials/associate/retrieve/associateFinancialRetrieveComponent";
...
class AssociateFinancialRetrieveContainer extends Component {
    /**
     *  Initializer & Utility
     *------------------------------------------------------------
     */
    ...
    render() {
        ...
        return (
            <AssociateFinancialRetrieveComponent
                id={this.state.id}
...
export default connect(
    mapStateToProps,
    mapDispatchToProps
)(AssociateFinancialRetrieveContainer);
