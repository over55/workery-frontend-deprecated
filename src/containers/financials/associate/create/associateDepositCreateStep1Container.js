...
import AssociateDepositCreateComponent from "../../../../components/financials/associate/create/associateDepositCreateStep1Component";
...
class AssociateDepositCreateStep1Container extends Component {
    /**
     *  Initializer & Utility
     *------------------------------------------------------------
     */
    ...
    onClick(e) {
        ...
        if (isValid) {
            this.props.history.push("/company-financial/"+this.state.orderId+"/deposit/create/step-2");
    ...
    render() {
        ...
        return (
            <AssociateDepositCreateComponent
                orderId={orderId}
...
export default connect(
    mapStateToProps,
    mapDispatchToProps
)(AssociateDepositCreateStep1Container);
