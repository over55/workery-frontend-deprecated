...
import AssociateZeroAmountDueStep2Component from "../../../../components/financials/associate/create/associateZeroAmountDueStep2Component";
...
class AssociateZeroAmountDueStep2Container extends Component {
    /**
     *  Initializer & Utility
     *------------------------------------------------------------
     */
    ...
    render() {
        ...
        return (
            <AssociateZeroAmountDueStep2Component
                orderId={orderId}
...
export default connect(
    mapStateToProps,
    mapDispatchToProps
)(AssociateZeroAmountDueStep2Container);
