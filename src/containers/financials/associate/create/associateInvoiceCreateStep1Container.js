...
import AssociateInvoiceCreateComponent from "../../../../components/financials/associate/create/associateInvoiceCreateStep1Component";
...
class AssociateInvoiceCreateContainer extends Component {
    ...
    onClick(e) {
        ...
        if (isValid) {
            this.props.history.push("/company-financial/"+this.state.orderId+"/invoice/create/step-2");
