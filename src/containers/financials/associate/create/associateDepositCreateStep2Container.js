...
import AssociateDepositCreateStep2Component from "../../../../components/financials/associate/create/associateDepositCreateStep2Component";
...
class AssociateDepositCreateStep2Container extends Component {
    /**
     *  Initializer & Utility
     *------------------------------------------------------------
     */
    ...
    render() {
        ...
        return (
            <AssociateDepositCreateStep2Component
                orderId={orderId}
...
export default connect(
    mapStateToProps,
    mapDispatchToProps
)(AssociateDepositCreateStep2Container);
