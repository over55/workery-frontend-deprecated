...
import AssociateZeroAmountDueStep1Component from "../../../../components/financials/associate/create/associateZeroAmountDueStep1Component";
...
class AssociateZeroAmountDueStep1Container extends Component {
    /**
     *  Initializer & Utility
     *------------------------------------------------------------
     */
    ...
    render() {
        ...
        return (
            <AssociateZeroAmountDueStep1Component
                orderId={orderId}
...
export default connect(
    mapStateToProps,
    mapDispatchToProps
)(AssociateZeroAmountDueStep1Container);
