...
import AssociateInvoiceCreateStep3Component from "../../../../components/financials/associate/create/associateInvoiceCreateStep3Component";
...
class AssociateInvoiceCreateStep3Container extends Component {
    /**
     *  Initializer & Utility
     *------------------------------------------------------------
     */
    ...
    render() {
        ...
        return (
            <AssociateInvoiceCreateStep3Component
                orderId={orderId}
...
export default connect(
    mapStateToProps,
    mapDispatchToProps
)(AssociateInvoiceCreateStep3Container);
