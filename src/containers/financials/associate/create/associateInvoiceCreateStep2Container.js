...
import AssociateInvoiceCreateComponent from "../../../../components/financials/associate/create/associateInvoiceCreateStep2Component";
...
class AssociateInvoiceCreateContainer extends Component {
    /**
     *  Initializer & Utility
     *------------------------------------------------------------
     */
    ...
    onClick(e) {
        ...
        if (isValid) {
            this.props.history.push("/company-financial/"+this.state.orderId+"/invoice/create/step-3");
    ...
    render() {
        ...
        return (
            <AssociateInvoiceCreateComponent
                orderId={orderId}
...
export default connect(
    mapStateToProps,
    mapDispatchToProps
)(AssociateInvoiceCreateContainer);
