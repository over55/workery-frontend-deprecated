...
import AssociateFinancialListComponent from "../../../../components/financials/associate/list/associateFinancialListComponent";
import { clearFlashMessage } from "../../../../actions/flashMessageActions";
import { pullOrderList } from "../../../../actions/orderActions";
import { STANDARD_RESULTS_SIZE_PER_PAGE_PAGINATION } from "../../../../constants/api";


class AssociateFinancialListContainer extends Component {
    /**
     *  Initializer & Utility
     *------------------------------------------------------------
     */
    ...
    render() {
        ...
        return (
            <AssociateFinancialListComponent
                page={page}
...
export default connect(
    mapStateToProps,
    mapDispatchToProps
)(AssociateFinancialListContainer);
