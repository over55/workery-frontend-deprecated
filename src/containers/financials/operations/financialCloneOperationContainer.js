...
import FinancialCloneOperationComponent from "../../../components/financials/operations/financialCloneOperationComponent";
import { setFlashMessage } from "../../../actions/flashMessageActions";
import { cloneOrder } from "../../../actions/orderActions";


class FinancialCloneOperationContainer extends Component {
    /**
     *  Initializer & Utility
     *------------------------------------------------------------
     */
    ...
    render() {
        ...
        return (
            <FinancialCloneOperationComponent
                orderId={orderId}
                errors={errors}
                isLoading={isLoading}
                reason={reason}
...
export default connect(
    mapStateToProps,
    mapDispatchToProps
)(FinancialCloneOperationContainer);
