...
import DownloadInvoicePDFOperationComponent from "../../../components/financials/operations/downloadInvoicePDFOperationComponent";
...
class DownloadInvoicePDFOperationContainer extends Component {
    /**
     *  Initializer & Utility
     *------------------------------------------------------------
     */
    ...
    render() {
        ...
        return (
            <DownloadInvoicePDFOperationComponent
                orderId={orderId}
                errors={errors}
                isLoading={isLoading}
            />
...
export default connect(
    mapStateToProps,
    mapDispatchToProps
)(DownloadInvoicePDFOperationContainer);
