...
import FinancialFullRetrieveComponent from "../../../components/financials/retrieve/financialFullRetrieveComponent";
...
class FinancialFullRetrieveContainer extends Component {
    /**
     *  Initializer & Utility
     *------------------------------------------------------------
     */
        ...
        if (this.state.slug === 'argyle') {
            ...
            this.setState({
                financialData: {
                    ...
                    anotherHouseholdFinancialRegisteredLabel: "No",
    ...
    render() {
        ...
        return (
            <FinancialFullRetrieveComponent
...
export default connect(
    mapStateToProps,
    mapDispatchToProps
)(FinancialFullRetrieveContainer);
