...
import { WORKERY_BULLETIN_BOARD_ITEM_LIST_API_URL, WORKERY_BULLETIN_BOARD_ITEM_DETAIL_API_URL } from '../constants/api';
...
export function pullBulletinBoardItemList(offset=0, limit=10, filtersMap=new Map(), onSuccessCallback=null, onFailureCallback=null) {
    return dispatch => {
        ...
        let aURL = WORKERY_BULLETIN_BOARD_ITEM_LIST_API_URL+"?offset="+offset+"&limit="+limit;
        filtersMap.forEach(
            (value, key) => {
...
export function postBulletinBoardItemDetail(postData, successCallback, failedCallback) {
    return dispatch => {
        ...
        customAxios.post(WORKERY_BULLETIN_BOARD_ITEM_LIST_API_URL, decamelizedData).then( (successResponse) => {
            const responseData = successResponse.data;
...
export function pullBulletinBoardItemDetail(id, successCallback, failedCallback) {
    return dispatch => {
        ...
        const aURL = WORKERY_BULLETIN_BOARD_ITEM_DETAIL_API_URL+id;
...
export function putBulletinBoardItemDetail(postData, successCallback, failedCallback) {
    return dispatch => {
        ...
        // Perform our API submission.
        customAxios.put(WORKERY_BULLETIN_BOARD_ITEM_DETAIL_API_URL+postData.id, decamelizedData).then( (successResponse) => {
