...
export function pullTenantList(offset=1, limit=10, filtersMap=new Map(), onSuccessCallback=null, onFailureCallback=null) {
    return dispatch => {
        ...
        let aURL = WORKERY_TENANT_LIST_API_URL+"?offset="+offset+"&offset_size="+limit;
        filtersMap.forEach(
            (value, key) => {
