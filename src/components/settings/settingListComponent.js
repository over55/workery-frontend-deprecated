                                ...
                                <div className="card-group row">
                                    ...
                                    <div className="col-sm-3">
                                        <div className="card box-shadow text-center mx-auto">
                                            ...
                                            <div className="card-body">
                                                <h3 className="card-title">Vehicle Type</h3>
                                                <p className="card-text">Modify vehicle types for associate.</p>
                                                <Link to="/settings/vehicle-types" className="btn btn-success btn-lg">
                                                    Go&nbsp;<i className="fas fa-arrow-circle-right"></i>
                                                </Link>
                                            </div>
                                        </div>
