            ...
            <div>
                ...
                <div className="row">
                    <div className="col-md-12">
                        ...
                        <button type="button" className="btn btn-lg float-right pl-4 pr-4 btn-success" onClick={onNextClick} disabled={bulletinBoardItems.length === 0 || bulletinBoardItems.length < STANDARD_RESULTS_SIZE_PER_PAGE_PAGINATION}>
