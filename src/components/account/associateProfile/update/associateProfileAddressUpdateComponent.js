...
class AssociateProfileAddressUpdateComponent extends Component {
    render() {
        const {
            // Step 5
                    ...
                    <div className="col-md-5 mx-auto mt-2">
                        <form>
                            ...
                            <div className="form-group">
                                ...
                                <Link to={`/profile/associate/full`} className="btn btn-orange btn-lg mt-4 float-left pl-4 pr-4">
...
export default AssociateProfileAddressUpdateComponent;
