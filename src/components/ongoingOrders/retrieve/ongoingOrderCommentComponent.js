...
export default class OngoingOrderCommentComponent extends Component {
    render() {
        const {
                ...
                <nav aria-label="breadcrumb">
                    <ol className="breadcrumb">
                        ...
                        <li className="breadcrumb-item active" aria-current="page">
                            <i className="fas fa-undo-alt"></i>&nbsp;Ongoing Order # {id.toLocaleString(navigator.language, { minimumFractionDigits: 0 })}
                        </li>
                    </ol>
                </nav>
