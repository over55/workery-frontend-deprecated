...
export default class AssociateFileUploadAddComponent extends Component {
    render() {
        const {
            title, description, tags, tagOptions, isTagSetsLoading, file, isArchived,
            flashMessage, isLoading, id, associate, onTextChange, onMultiChange, errors, onClick,
                    ...
                    <div className="col-md-5 mx-auto mt-2">
                        <form>
                            ...
                            <div className="form-group">
                                ...
                                <Link to={`/associate/${id}/files`} className="btn btn-secondary btn-lg mt-4 float-left pl-4 pr-4">
