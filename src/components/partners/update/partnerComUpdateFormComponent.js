...
export default class PartnerComUpdateFormComponent extends Component {
    render() {
        ...
        const { tags, tagOptions, birthYear, gender, howDidYouHear, howDidYouHearOptions, howDidYouHearOther, meaning, expectations, willingToVolunteer, anotherHouseholdPartnerRegistered, totalHouseholdCount, under18YearsHouseholdCount, } = this.props;
