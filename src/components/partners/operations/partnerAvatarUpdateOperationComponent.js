...
export default class PartnerAvatarUpdateOperationComponent extends Component {
    render() {
        const {
            file, isLoading, id, partner, errors, onClick, onFileDrop, onRemoveFileUploadClick
        } = this.props;
        return (
            <div>
                    ...
                    <div className="col-md-5 mx-auto mt-2">
                        <form>
                            ...
                            <div className="form-group">
                                ...
                                <Link to={`/partner/${id}`} className="btn btn-secondary btn-lg mt-4 float-left pl-4 pr-4">
