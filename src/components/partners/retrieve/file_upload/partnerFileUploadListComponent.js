...
class PartnerFileUploadListComponent extends Component {
    render() {
        const {
            // Pagination
            page, sizePerPage, totalSize,
                        ...
                        <section className="row text-center placeholders">
                            <div className="col-sm-12 placeholder">
                                <div className="rounded-circle mx-auto mt-4 mb-4 circle-200 bg-pink">
                                    <Link to={`/partner/${id}/file/add`} className="d-block link-ndecor" title="Partners">
...
export default PartnerFileUploadListComponent;
