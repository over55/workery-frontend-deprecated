...
export default class PartnerFileUploadAddComponent extends Component {
    render() {
        const {
            title, description, tags, tagOptions, isTagSetsLoading, file, isArchived,
            flashMessage, isLoading, id, partner, onTextChange, onMultiChange, errors, onClick,
                    ...
                    <div className="col-md-5 mx-auto mt-2">
                        <form>
                            ...
                            <div className="form-group">
                                ...
                                <Link to={`/partner/${id}/files`} className="btn btn-secondary btn-lg mt-4 float-left pl-4 pr-4">
