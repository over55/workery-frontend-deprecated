...
export default class PartnerCommentComponent extends Component {
    render() {
        const {
            partnerComments, flashMessage, isLoading, id, partner, text, onTextChange, errors, onClick
        } = this.props;
        return (
            <div>
                ...
                <div className="row align-items-start">
                    ...
                    <div className="col-lg-12">
                        {partnerComments && partnerComments.map(
