...
class PartnerCreateStep3BizComponent extends Component {
    render() {
        const {
            ...
            telephone, telephoneTypeOf,
            otherTelephone, otherTelephoneTypeOf, email, errors,
                    ...
                    <div className="col-md-5 mx-auto mt-2">
                        <form>
                            ...
                            <div className="form-group">
                                ...
                                <Link to="/partners/add/step-3" className="btn btn-orange btn-lg mt-4 float-left pl-4 pr-4">
...
export default PartnerCreateStep3BizComponent;
