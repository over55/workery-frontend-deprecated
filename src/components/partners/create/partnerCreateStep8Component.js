...
export default class PartnerCreateStep8Component extends Component {
                    ...
                    <div className="col-md-10 mx-auto p-2">
                        ...
                        <form>
                            <div className="form-group">
                                ...
                                <Link to="/partners/add/step-7" className="btn btn-secondary btn-lg mt-4 float-left pl-4 pr-4">
