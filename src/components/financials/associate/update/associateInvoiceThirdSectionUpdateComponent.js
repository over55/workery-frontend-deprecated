...
class AssociateInvoiceThirdSectionUpdateComponent extends Component {
    render() {
        const {
                    ...
                    <div className="col-md-5 mx-auto mt-2">
                        <form>
                            ...
                            <div className="form-group">
                                ...
                                <Link to={`/company-financial/${orderId}/invoice`} className="btn btn-secondary btn-lg mt-4 float-left pl-4 pr-4">
...
export default AssociateInvoiceThirdSectionUpdateComponent;
