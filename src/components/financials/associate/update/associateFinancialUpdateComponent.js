...
export default class AssociateFinancialUpdateComponent extends Component {
    render() {
        const {
            // TEXT
            invoiceIds,
            ...
            <main id="main" role="main">
                ...
                <nav aria-label="breadcrumb">
                    <ol className="breadcrumb">
                        ...
                        <li className="breadcrumb-item" aria-current="page">
                            <Link to={`/company-financial/${id}`}><i className="fas fa-money-check-alt"></i>&nbsp;Order #{id && id.toLocaleString(navigator.language, { minimumFractionDigits: 0 })}</Link>
                        </li>
                    ...
                    <div className="col-md-5 mx-auto mt-2">
                        <form>
                            ...
                            <BootstrapCurrencyInput
                                ...
                                helpText="If no other costs where inccured then please enter zero."
                            />
                            ...
                            <BootstrapCurrencyInput
                                ...
                                label="Actual Quoted Costs (*)"
                                onChange={onAmountChange}
                                value={invoiceOtherCostsAmount}
                                name="invoiceOtherCostsAmount"
                                helpText="If no other costs where incurred then please enter zero."
                            />
                            ...
                            <div className="form-group">
                                ...
                                <Link to={`/company-financial/${id}`} className="btn btn-orange btn-lg mt-4 float-left pl-4 pr-4">
