                ...
                <div className="row">
                    <div className="step-navigation">
                        <div id="step-1" className="st-grey">
                            <Link to={`/financial/${orderId}/deposit/create/step-1`}>
                    ...
                    <div className="col-md-10 mx-auto p-2">
                        ...
                        <form>
                            <div className="form-group">
                                ...
                                <Link to={`/financial/${orderId}/deposit/create/step-1`} className="btn btn-secondary btn-lg mt-4 float-left pl-4 pr-4">
