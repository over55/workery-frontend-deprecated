...
class AdminDepositCreateStep1Component extends Component {
    render() {
        const {
            orderId, order,
                    ...
                    <div className="col-md-5 mx-auto mt-2">
                        <form>
                            ...
                            <div className="form-group">
                                ...
                                <Link to={`/financial/${orderId}/deposits`} className="btn btn-orange btn-lg mt-4 float-left pl-4 pr-4">
...
export default AdminDepositCreateStep1Component;
