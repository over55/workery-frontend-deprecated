                    ...
                    <div className="col-md-10 mx-auto p-2">
                        ...
                        <form>
                            <div className="form-group">
                                ...
                                <Link to={`/financial/${orderId}/invoice/create/step-3`} className="btn btn-orange btn-lg mt-4 float-left pl-4 pr-4">
...
export default AdminInvoiceCreateStep2Component;
