                ...
                <div className="row">
                    <div className="col-md-5 mx-auto mt-2">
                        <form>
                            ...
                            <BootstrapDatePicker
                                label={paymentStatus === WORK_ORDER_COMPLETED_AND_PAID_STATE ? "Completion date (*)" : "Completion date"}
                                name="completionDate"
                            ...
                            <BootstrapCurrencyInput
                                ...
                                helpText="If no other costs will be incurred then please enter zero."
                            />
                            ...
                            <div className="form-group">
                                ...
                                <Link to={`/financial/${id}`} className="btn btn-orange btn-lg mt-4 float-left pl-4 pr-4">
