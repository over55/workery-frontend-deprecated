...
class AuthenticatedMessage extends Component {
    render() {
        ...
        return (
            <div>
                <p className="text-center text-secondary lead mb-4">Unfortunately we are having trouble loading the page your are looking for. You can return to your <Link to={user.dashboardPath}>dashboard</Link>. For immediate help, contact  <a href="mailto:support@workery.ca">support.</a></p>
                <br />
                <h4>Phone: <a href="tel:15194381111">(519) 438-1111</a></h4>
                <h4>E-Mail: <a href="mailto:support@workery.ca">support@workery.ca</a></h4>
                <br />
                <br />
...
class AnonymousMessage extends Component {
    render() {
        return (
            <div>
                <p className="text-center text-secondary lead mb-4">Unfortunately we are having trouble loading the page your are looking for. You can return to the <Link to="/">home</Link> page. For immediate help, contact  <a href="mailto:support@workery.ca">support.</a></p>
                <br />
                <h4>Phone: <a href="tel:15194381111">(519) 438-1111</a></h4>
                <h4>E-Mail: <a href="mailto:support@workery.ca">support@workery.ca</a></h4>
                <br />
