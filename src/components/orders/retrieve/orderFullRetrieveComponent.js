                    ...
                    <div className="col-md-10 mx-auto p-2">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <ul>
                                            <li>
                                                <Link to={`/order/${slug}/promote/step-1`}>
                        ...
                        <form>
                            <div className="form-group">
                                <Link to={`/order/${slug}/update`} className="btn btn-primary btn-lg mt-4 float-right pl-4 pr-4">
                                    <i className="fas fa-edit"></i>&nbsp;Update
                                </Link>
                                <Link to={`/orders`} className="btn btn-secondary btn-lg mt-4 float-left pl-4 pr-4">
