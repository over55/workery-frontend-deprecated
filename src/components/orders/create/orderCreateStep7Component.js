...
export default class OrderCreateStep7Component extends Component {
    render() {
        const {
                    ...
                    <div className="col-md-5 mx-auto mt-2">
                        <form>
                            ...
                            <BootstrapRadio
                                inputClassName="form-check-input form-check-input-lg"
                                borderColour="border-primary"
                                error={errors.anotherHouseholdOrderRegistered}
                                label="Is there another order of your household which is registered with us? (*)"
                                name="anotherHouseholdOrderRegistered"
                                onChange={onRadioChange}
                                selectedValue={anotherHouseholdOrderRegistered}
                            ...
                            <div className="form-group">
                                ...
                                <Link to="/orders/add/step-6" className="btn btn-secondary btn-lg mt-4 float-left pl-4 pr-4">
