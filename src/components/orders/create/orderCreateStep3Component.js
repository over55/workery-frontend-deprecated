                    ...
                    <div className="col-sm-6">
                        <div className="card box-shadow text-center mx-auto">
                            ...
                            <div className="card-body">
                                ...
                                <Link to="/orders/add/step-4-rez-or-cc" className="btn btn-primary btn-lg">
                    ...
                    <div className="col-sm-6">
                        <div className="card box-shadow text-center mx-auto">
                            ...
                            <div className="card-body">
                                ...
                                <p className="card-text">Add a business order</p>
                                <Link to="/orders/add/step-4-biz" className="btn btn-primary btn-lg">
                                    Select&nbsp;<i className="fas fa-arrow-circle-right"></i>
                                </Link>
                            </div>
                        </div>
