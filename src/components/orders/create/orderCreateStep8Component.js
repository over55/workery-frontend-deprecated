...
export default class OrderCreateStep8Component extends Component {
    ...
    render() {
        const {
            ...
            meaning, expectations, willingToVolunteer, willingToVolunteerLabel, anotherHouseholdOrderRegistered, anotherHouseholdOrderRegisteredLabel, totalHouseholdCount, under18YearsHouseholdCount,
        ...
        if (typeOf === BUSINESS_TYPE_OF) {
            ordershipClass = "Business";
        }
        else if (typeOf === RESIDENCE_TYPE_OF) {
            ordershipClass = "Residential";
        }
        else if (typeOf === COMMUNITY_CARES_TYPE_OF) {
            ordershipClass = "Community Cares";
        }
        ...
        try {
            showHouseholdCount = parseInt(anotherHouseholdOrderRegistered) === 0;
        } catch (error) {
            // Do nothing.
        }
                    ...
                    <div className="col-md-10 mx-auto p-2">
                        ...
                        <table className="table table-bordered custom-cell-w">
                            <tbody>
                                ...
                                <tr>
                                    <th scope="row" className="bg-light">Ordership Class</th>
                                    <td>{ordershipClass}</td>
                                </tr>
                                ...
                                <tr>
                                    <th scope="row" className="bg-light">Is there another order of your household which is registered with?</th>
                                    <td>{anotherHouseholdOrderRegisteredLabel}</td>
                                </tr>
                                {showHouseholdCount &&
                                    <tr>
                        ...
                        <form>
                            <div className="form-group">
                                ...
                                <Link to="/orders/add/step-7" className="btn btn-secondary btn-lg mt-4 float-left pl-4 pr-4">
