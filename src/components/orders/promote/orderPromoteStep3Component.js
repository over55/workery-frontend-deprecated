...
export default class OrderPromoteStep2Component extends Component {
    render() {
            ...
            <main id="main" role="main">
                <nav aria-label="breadcrumb">
                    <ol className="breadcrumb">
                        ...
                        <li className="breadcrumb-item" aria-current="page">
                            <Link to={`/order/${slug}`}><i className="fas fa-user"></i>&nbsp;Argyle</Link>
                        </li>
                ...
                <h1><i className="fas fa-star"></i>&nbsp;Promote Order</h1>

                <div className="row">
                    <div className="step-navigation">
                        <div id="step-1" className="st-grey">
                            <span className="num">1.</span><span className="">
                                <Link to={`/order/${slug}/promote/step-1`}>Selection</Link>
                            </span>
                        </div>
                        <div id="step-2" className="st-grey">
                            <span className="num">2.</span><span className="">
                                <Link to={`/order/${slug}/promote/step-2`}>Agreement</Link>
                            </span>
                        </div>
                ...
                <div className="row pt-3 mb-4 pb-2">
                    <div className="col-md-10 mx-auto p-2">
                        ...
                        <p><strong>Please confirm these details before promoting the order:</strong></p>
                        ...
                        <form>
                            <div className="form-group">
                                ...
                                <Link to={`/order/${slug}/promote/step-2`} className="btn btn-secondary btn-lg mt-4 float-left pl-4 pr-4">
