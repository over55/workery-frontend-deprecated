...
export default class OrderPromoteStep1Component extends Component {
    render() {
                    ...
                    <div className="col-sm-6">
                        <div className="card box-shadow text-center mx-auto">
                            ...
                            <div className="card-body">
                                ...
                                <p className="card-text">Promote the order to be an area coordinator.</p>
                    ...
                    <div className="col-sm-6">
                        <div className="card box-shadow text-center mx-auto">
                            ...
                            <div className="card-body">
                                ...
                                <p className="card-text">Promote the order to be an associate.</p>
