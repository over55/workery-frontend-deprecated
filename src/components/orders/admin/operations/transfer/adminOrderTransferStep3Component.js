...
class AdminOrderTransferStep3Component extends Component {
    render() {
                    ...
                    <div className="col-md-12 text-center">
                        ...
                        <div className="col-md-12 text-center">
                            <button className="btn btn-warning btn-lg mt-4 pl-4 pr-4" type="button" onClick={onSkipClick}>
                                Use existing Associate&nbsp;<i className="fas fa-arrow-circle-right"></i>
                            </button>
                        </div>
                    </div>
                </div>
...
export default AdminOrderTransferStep3Component;
