            ...
            <main id="main" role="main">
                <nav aria-label="breadcrumb">
                    <ol className="breadcrumb">
                        ...
                        <li className="breadcrumb-item" aria-current="page">
                            <Link to={`/client/${client.id}/operations`}><i className="fas fa-user"></i>&nbsp;{client && client.name}</Link>
                        </li>
                    ...
                    <div className="col-md-5 mx-auto mt-2">
                        <form>
                            ...
                            <div className="form-group">
                                ...
                                <Link to={`/client/${client.id}/operations`} className="btn btn-orange btn-lg mt-4 float-left pl-4 pr-4">
