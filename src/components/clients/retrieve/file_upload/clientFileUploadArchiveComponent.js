...
export default class ClientFileUploadArchiveComponent extends Component {
    render() {
        const {
            isLoading, id, client, errors, onClick
        } = this.props;
        return (
            <div>
                    ...
                    <div className="col-md-5 mx-auto mt-2">
                        <form>
                            ...
                            <div className="jumbotron">
                                ...
                                <p className="lead">You are about to archive the file, this file will no longer be available to the staff and the client.</p>
                            </div>
                            ...
                            <div className="form-group">
                                ...
                                <Link to={`/client/${id}/files`} className="btn btn-orange btn-lg mt-4 float-left pl-4 pr-4">
