...
export default class ClientCommentComponent extends Component {
    render() {
        const {
            clientComments, flashMessage, isLoading, id, client, text, onTextChange, errors, onClick
        } = this.props;
        return (
            <div>
                ...
                <div className="row align-items-start">
                    ...
                    <div className="col-lg-12">
                        {clientComments && clientComments.map(
        ...
        return (
            <div className="media mt-4">
                ...
                <div className="media-body">
                    <div className="row">
                        <h5 className="mt-0 col-sm-10"><strong>{comment.createdByName}</strong></h5>
                        <h6 className="col-sm-2 text-secondary text-right">
                            <Moment format="MM/DD/YYYY hh:mm:ss a">{comment.createdTime}</Moment>
                        </h6>
                    </div>
                    <p>{ comment.text }</p>
                </div>
