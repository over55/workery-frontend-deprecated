...
export default class ClientDemoteComponent extends Component {
    render() {
        const {
            ...
            <main id="main" role="main">
                <nav aria-label="breadcrumb">
                    <ol className="breadcrumb">
                        ...
                        <li className="breadcrumb-item" aria-current="page">
                            <Link to={`/client/${slug}`}><i className="fas fa-user-circle"></i>&nbsp;Argyle</Link>
                        </li>
                ...
                <h1><i className="fas fa-star-half"></i>&nbsp;Demote Client</h1>
                    ...
                    <form id="business-form" method="post" className="needs-validation" action="" noValidate>
                        <div className="form-group">
                            ...
                            <div className="form-group">
                                ...
                                <Link to={`/client/${slug}`} className="btn btn-secondary btn-lg mt-4 float-left pl-4 pr-4">
