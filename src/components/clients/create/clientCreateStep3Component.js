                    ...
                    <div className="col-sm-6">
                        <div className="card box-shadow text-center mx-auto">
                            ...
                            <div className="card-body">
                                ...
                                <button className="btn btn-success btn-lg" onClick={ (event)=>{ onClick(event, RESIDENTIAL_ASSOCIATE_TYPE_OF_ID, "Residential") } }>
                    ...
                    <div className="col-sm-6">
                        <div className="card box-shadow text-center mx-auto">
                            ...
                            <div className="card-body">
                                ...
                                <button className="btn btn-success btn-lg" onClick={ (event)=>{ onClick(event, COMMERCIAL_ASSOCIATE_TYPE_OF_ID, "Business") } }>
                                    Select&nbsp;<i className="fas fa-arrow-circle-right"></i>
                                </button>
                            </div>
                        </div>
