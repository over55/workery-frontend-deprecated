...
function externalLinkFormatter(cell, row){
    return (
        <a target="_blank" href={`/client/${row.slug}`}>
...
class ClientSearchResultComponent extends Component {
    render() {
        ...
        return (
            <div>
                ...
                <div className="form-group">
                    <Link to="/clients/search" className="btn btn-secondary btn-lg">
...
export default ClientSearchResultComponent;
