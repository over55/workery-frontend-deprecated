...
class StaffCreateStep5Component extends Component {
    render() {
        const {
            country,
                    ...
                    <div className="col-md-5 mx-auto mt-2">
                        <form>
                            ...
                            <div className="form-group">
                                ...
                                <Link to="/staff/add/step-4" className="btn btn-orange btn-lg mt-4 float-left pl-4 pr-4">
...
export default StaffCreateStep5Component;
