...
export default class StaffAvatarUpdateOperationComponent extends Component {
    render() {
        const {
            file, isLoading, id, staff, errors, onClick, onFileDrop, onRemoveFileUploadClick
        } = this.props;
        return (
            <div>
                    ...
                    <div className="col-md-5 mx-auto mt-2">
                        <form>
                            ...
                            <div className="form-group">
                                ...
                                <Link to={`/staff/${id}`} className="btn btn-secondary btn-lg mt-4 float-left pl-4 pr-4">
