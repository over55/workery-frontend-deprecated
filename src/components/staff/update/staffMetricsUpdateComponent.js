...
export default class StaffRezUpdateComponent extends Component {
    render() {
        const {
            ...
            <main id="main" role="main">
                ...
                <div className="row">
                    <div className="col-md-5 mx-auto mt-2">
                        <form>
                            <h1><i className="fas fa-edit"></i>&nbsp;Staff Metrics Form</h1>
                            ...
                            <BootstrapTextarea
                                ...
                                borderColour="border-success"
                                label="Description"
                                placeholder="Please a description of the staff."
                                rows="5"
                                value={description}
                                helpText=""
                                onChange={onTextChange}
