...
export default class Report6Component extends Component {
    render() {
            ...
            <main id="main" role="main">
                ...
                <nav aria-label="breadcrumb">
                    <ol className="breadcrumb">
                        ...
                        <li className="breadcrumb-item active" aria-current="page">
                            <i className="fas fa-shield-alt"></i>&nbsp;Associate Police Check Report
                        </li>
                    </ol>
                </nav>
                ...
                <div className="row">
                    <div className="col-md-5 mx-auto mt-2">
                        <form>
                            <h1><i className="fas fa-shield-alt"></i>&nbsp;Associate Police Check Report</h1>
