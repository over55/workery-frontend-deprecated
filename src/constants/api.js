...
export const WORKERY_CLIENT_ARCHIVE_API_ENDPOINT = '/customer-operations/archive';
export const WORKERY_CLIENT_REZ_UPGRADE_API_ENDPOINT = '/customer-operations/upgrade-residential';
export const WORKERY_CLIENT_PERMANENTLY_DELETE_UPGRADE_API_ENDPOINT = '/customer-operations/permanently-delete';
export const WORKERY_CLIENT_AVATAR_CREATE_OR_UPDATE_API_ENDPOINT = '/customer-operations/upload-avatar';
...
export const WORKERY_ORDER_TRANSFER_OPERATION_API_ENDPOINT = '/order-operations/transfer';
export const WORKERY_ORDER_UNASSIGN_ASSOCIATE_OPERATION_API_ENDPOINT = '/order-operations/unassign';
export const WORKERY_ORDER_CLOSE_OPERATION_API_ENDPOINT = '/order-operations/close';
export const WORKERY_ORDER_REOPEN_OPERATION_API_ENDPOINT = '/order-operations/reopen';
export const WORKERY_ORDER_POSTPONE_OPERATION_API_ENDPOINT = '/order-operations/postpone';
export const WORKERY_TASK_ORDER_COMPLETION_OPERATION_API_ENDPOINT = '/order-operations/order-completion';
export const WORKERY_ORDER_CLONE_OPERATION_API_ENDPOINT = '/order-operations/clone';
export const WORKERY_ORDER_INVOICE_OPERATION_API_ENDPOINT = '/order-operations/invoice';
...
export const WORKERY_ASSOCIATE_AVATAR_CREATE_OR_UPDATE_API_ENDPOINT = '/associate-operations/upload-avatar';
export const WORKERY_ASSOCIATE_BALANCE_OPERATION_API_ENDPOINT = '/associate-operations/balance';
export const WORKERY_ASSOCIATE_CHANGE_PASSWORD_OPERATION_API_ENDPOINT = '/associate-operations/password';
...
export const WORKERY_TASK_AVAILABLE_ASSOCIATE_LIST_CREATE_API_ENDPOINT = 'task-operations/available-associates';
export const WORKERY_TASK_ASSIGN_ASSOCIATE_OPERATION_API_ENDPOINT = '/task-operations/assign-associate';
export const WORKERY_TASK_FOLLOW_UP_OPERATION_API_ENDPOINT = '/task-operations/follow-up';
export const WORKERY_TASK_FOLLOW_UP_PENDING_OPERATION_API_ENDPOINT = '/task-operations/follow-up-pending';
export const WORKERY_TASK_ORDER_COMPLETION_API_ENDPOINT = '/task-operations/order-completion';
export const WORKERY_TASK_SURVEY_OPERATION_API_ENDPOINT = '/task-operations/survey';
export const WORKERY_STAFF_LIST_API_ENDPOINT = '/staff';
...
export const WORKERY_STAFF_CHANGE_ROLE_OPERATION_API_ENDPOINT = '/staff-operations/change-role';
export const WORKERY_STAFF_CHANGE_PASSWORD_OPERATION_API_ENDPOINT = '/staff-operations/change-password';
...
export const WORKERY_PRIVATE_FILE_LIST_API_ENDPOINT = '/private-files';
export const WORKERY_PRIVATE_FILE_DETAIL_API_ENDPOINT = '/private-file/';
export const WORKERY_HOW_HEAR_LIST_API_ENDPOINT = '/how-hears';
export const WORKERY_HOW_HEAR_DETAIL_API_ENDPOINT = '/how-hear/';
export const WORKERY_AWAY_LOG_LIST_API_ENDPOINT = '/associate-away-logs';
export const WORKERY_AWAY_LOG_DETAIL_API_ENDPOINT = '/associate-away-log/';
export const WORKERY_BULLETIN_BOARD_ITEM_LIST_API_ENDPOINT = '/bulletin-board-items';
export const WORKERY_BULLETIN_BOARD_ITEM_DETAIL_API_ENDPOINT = '/bulletin-board-item/';
export const WORKERY_SKILL_SET_LIST_API_ENDPOINT = '/skill-sets';
export const WORKERY_SKILL_SET_DETAIL_API_ENDPOINT = '/skill-set/';
export const WORKERY_INSURANCE_REQUIREMENT_LIST_API_ENDPOINT = '/insurance-requirements';
export const WORKERY_INSURANCE_REQUIREMENT_DETAIL_API_ENDPOINT = '/insurance-requirement/';
export const WORKERY_SERVICE_FEE_LIST_API_ENDPOINT = '/order-service-fees';
export const WORKERY_SERVICE_FEE_DETAIL_API_ENDPOINT = '/order-service-fee/';
export const WORKERY_ARCHIVED_CLIENT_LIST_API_ENDPOINT = '/deactivated-customers';
export const WORKERY_VEHICLE_TYPE_LIST_API_ENDPOINT = '/vehicle-types';
export const WORKERY_VEHICLE_TYPE_DETAIL_API_ENDPOINT = '/vehicle-type/';
export const WORKERY_PARTNER_LIST_API_ENDPOINT = '/partners';
export const WORKERY_PARTNER_DETAIL_API_ENDPOINT = '/partner/';
export const WORKERY_PARTNER_ARCHIVE_API_ENDPOINT = '/partner-operations/archive';
export const WORKERY_PARTNER_REZ_UPGRADE_API_ENDPOINT = '/partner-operations/upgrade-residential';
export const WORKERY_PARTNER_PERMANENTLY_DELETE_UPGRADE_API_ENDPOINT = '/partner-operations/permanently-delete';
export const WORKERY_PARTNER_AVATAR_CREATE_OR_UPDATE_API_ENDPOINT = '/partner-operations/upload-avatar';
...
export const WORKERY_REPORT_ONE_CSV_DOWNLOAD_API_ENDPOINT = 'api/v1/download-report/1';
export const WORKERY_REPORT_TWO_CSV_DOWNLOAD_API_ENDPOINT = 'api/v1/download-report/2';
export const WORKERY_REPORT_THREE_CSV_DOWNLOAD_API_ENDPOINT = 'api/v1/download-report/3';
export const WORKERY_REPORT_FOUR_CSV_DOWNLOAD_API_ENDPOINT = 'api/v1/download-report/4';
export const WORKERY_REPORT_FIVE_CSV_DOWNLOAD_API_ENDPOINT = 'api/v1/download-report/5';
export const WORKERY_REPORT_SIX_CSV_DOWNLOAD_API_ENDPOINT = 'api/v1/download-report/6';
export const WORKERY_REPORT_SEVEN_CSV_DOWNLOAD_API_ENDPOINT = 'api/v1/download-report/7';
export const WORKERY_REPORT_EIGHT_CSV_DOWNLOAD_API_ENDPOINT = 'api/v1/download-report/8';
export const WORKERY_REPORT_NINE_CSV_DOWNLOAD_API_ENDPOINT = 'api/v1/download-report/9';
export const WORKERY_REPORT_TEN_CSV_DOWNLOAD_API_ENDPOINT = 'api/v1/download-report/10';
export const WORKERY_REPORT_ELEVEN_CSV_DOWNLOAD_API_ENDPOINT = 'api/v1/download-report/11';
export const WORKERY_REPORT_TWELVE_CSV_DOWNLOAD_API_ENDPOINT = 'api/v1/download-report/12';
export const WORKERY_REPORT_THIRTEEN_CSV_DOWNLOAD_API_ENDPOINT = 'api/v1/download-report/13';
export const WORKERY_REPORT_FOURTEEN_CSV_DOWNLOAD_API_ENDPOINT = 'api/v1/download-report/14';
export const WORKERY_REPORT_FIFTHTEEN_CSV_DOWNLOAD_API_ENDPOINT = 'api/v1/download-report/15';
export const WORKERY_REPORT_SIXTEEN_CSV_DOWNLOAD_API_ENDPOINT = 'api/v1/download-report/16';
export const WORKERY_REPORT_SEVENTEEN_CSV_DOWNLOAD_API_ENDPOINT = 'api/v1/download-report/17';
export const WORKERY_REPORT_NINETEEN_CSV_DOWNLOAD_API_ENDPOINT = 'api/v1/download-report/19';
export const WORKERY_REPORT_TWENTY_CSV_DOWNLOAD_API_ENDPOINT = 'api/v1/download-report/20';
export const WORKERY_REPORT_TWENTY_ONE_CSV_DOWNLOAD_API_ENDPOINT = 'api/v1/download-report/21';
export const WORKERY_REPORT_TWENTY_TWO_CSV_DOWNLOAD_API_ENDPOINT = 'api/v1/download-report/22';
