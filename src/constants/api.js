...
export const WORKERY_TENANT_LIST_API_URL = HTTP_API_SERVER + '/api/v1/franchises';
export const WORKERY_TENANT_DETAIL_API_URL = HTTP_API_SERVER + '/api/v1/franchise/{id}';
