...
export const WORKERY_ASSOCIATE_UPGRADE_OPERATION_API_ENDPOINT = '/customer-operations/upgrade-residential';
export const WORKERY_ASSOCIATE_DOWNGRADE_OPERATION_API_ENDPOINT = '/customer-operations/downgrade-commercial';
