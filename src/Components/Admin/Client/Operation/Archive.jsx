                ...
                <section class="section">
                    ...
                    <nav class="breadcrumb has-background-light p-4 is-hidden-touch" aria-label="breadcrumbs">
                        <ul>
                            ...
                            <li class="is-active"><Link aria-current="page"><FontAwesomeIcon className="fas" icon={faArchive} />&nbsp;Archive</Link></li>
                        </ul>
                    </nav>
                    ...
                    <nav class="box">
                        ...
                        {client && <div class="columns">
                            <div class="column">
                                <p class="title is-4"><FontAwesomeIcon className="fas" icon={faArchive} />&nbsp;Archive Client - Are you sure?</p>
                            </div>
                                ...
                                {client && <div class="container">
                                    ...
                                    <div class="columns pt-5">
                                        ...
                                        <div class="column is-half has-text-right">
                                            <button class="button is-danger is-fullwidth-mobile" onClick={onSubmitClick}><FontAwesomeIcon className="fas" icon={faCheckCircle} type="button" />&nbsp;Confirm and Archive</button>
                                        </div>
                                    </div>
