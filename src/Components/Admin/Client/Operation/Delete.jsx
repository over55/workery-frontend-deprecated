                ...
                <section class="section">
                    ...
                    <nav class="breadcrumb has-background-light p-4 is-hidden-touch" aria-label="breadcrumbs">
                        <ul>
                            ...
                            <li class="is-active"><Link aria-current="page"><FontAwesomeIcon className="fas" icon={faTrashCan} />&nbsp;Delete</Link></li>
                        </ul>
                    </nav>
                    ...
                    <nav class="box">
                        ...
                        {client && <div class="columns">
                            <div class="column">
                                <p class="title is-4"><FontAwesomeIcon className="fas" icon={faTrashCan} />&nbsp;Delete Client - Are you sure?</p>
                            </div>
                        ...
                        {isFetching
                            ...
                            <>
                                ...
                                {client && <div class="container">
                                    <p>You are about to <b>permanently delete</b> this client; it will no longer exist in our database. This action can be undone but you'll need to contact the system administrator. Are you sure you would like to continue?</p>
                                    ...
                                    <div class="columns pt-5">
                                        ...
                                        <div class="column is-half has-text-right">
                                            <button class="button is-danger is-fullwidth-mobile" onClick={onSubmitClick}><FontAwesomeIcon className="fas" icon={faCheckCircle} type="button" />&nbsp;Confirm and Delete</button>
                                        </div>
                                    </div>
