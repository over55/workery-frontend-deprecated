...
import { faBuildingUser, faImage, faPaperclip, faAddressCard, faSquarePhone, faTasks, faTachometer, faPlus, faArrowLeft, faCheckCircle, faUserCircle, faGauge, faPencil, faUsers, faEye, faIdCard, faAddressBook, faContactCard, faChartPie, faBuilding, faEllipsis, faStar } from '@fortawesome/free-solid-svg-icons'
                ...
                <section class="section">
                    ...
                    <nav class="breadcrumb has-background-light p-4 is-hidden-touch" aria-label="breadcrumbs">
                        <ul>
                            ...
                            <li class="is-active"><Link aria-current="page"><FontAwesomeIcon className="fas" icon={faStar} />&nbsp;Upgrade</Link></li>
                        </ul>
                    </nav>
                    ...
                    <nav class="box">
                        ...
                        {client && <div class="columns">
                            <div class="column">
                                <p class="title is-4"><FontAwesomeIcon className="fas" icon={faStar} />&nbsp;Upgrade Client - Are you sure?</p>
                            </div>
                        ...
                        {isFetching
                            ...
                            <>
                                ...
                                {client && <div class="container">
                                    <p>You are about to <b>archive</b> this client; it will no longer exist in list. This action can be undone but you'll need to contact the system administrator. Are you sure you would like to continue?</p>
