...
*/
function RootOrganizationListMobile(props) {
                ...
                return <div class="mb-5" key={`mobile_tablet_${datum.id}`}>
                    ...
                    <div class="is-hidden-mobile pt-2" key={`tablet_${datum.id}`}>
                        <div className="buttons is-right">
                            <Link to={`/root/organization/${datum.id}`} class="button is-small is-primary" type="button">
                                <FontAwesomeIcon className="mdi" icon={faEye} />&nbsp;View
                            </Link>
                            <Link to={`/root/organization/${datum.id}/edit`} class="button is-small is-warning" type="button">
                                <FontAwesomeIcon className="mdi" icon={faPencil} />&nbsp;Edit
                            </Link>
                            <div class="column">
                                <Link to={`/root/organization/${datum.id}/start`} class="button is-small is-success">Start&nbsp;<FontAwesomeIcon icon={faChevronRight} /></Link>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="is-hidden-tablet pt-2" key={`mobile_${datum.id}`}>
                        <div class="columns is-mobile">
                            <div class="column">
                                <Link to={`/root/organization/${datum.id}`} class="button is-small is-primary is-fullwidth" type="button">
                                    <FontAwesomeIcon className="mdi" icon={faEye} />&nbsp;View
                                </Link>
                            </div>
                            <div class="column">
                                <Link to={`/root/organization/${datum.id}/edit`} class="button is-small is-warning is-fullwidth" type="button">
                                    <FontAwesomeIcon className="mdi" icon={faPencil} />&nbsp;Edit
                                </Link>
                            </div>
                            <div class="column">
...
export default RootOrganizationListMobile;
